...
<template>
  ...
  >
    ...
    <!-- Search Box --> <div class="flex flex-1 items-stretch h-14">  
        <slot />
      </div> <!-- Search Box -->


    <!-- Mobile Version Menu --> <div class="flex-none items-stretch flex h-14 lg:hidden"> 
        <NavBarItemPlain
      ...
      </div> <!-- Mobile Version Menu -->


      <!-- Web Version Menu --> <div
